	...
	public void run(){
		...
		try {
			...
			case "hcrs":
				...
				//存在--改变状态
				if(i.equals("1")) {
					new UpdateThreadParkStatusBlank(Integer.valueOf(str[2]), Integer.valueOf(str[3]));
				...
				//不存在---添加记录
					...
					new InsertThreadInParkStatus(Integer.valueOf(str[2]), 0, 0, Integer.valueOf(str[3]));
				}
				break;
				
			case "relay":
				//主闸
				if(str[2].equals("mian")) {
					// TODO
				}
				else {
